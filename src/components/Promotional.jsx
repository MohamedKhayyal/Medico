        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-start h-full w-full px-4 md:px-16 lg:px-32 py-2">
          <div className="w-full md:w-1/2 flex flex-col justify-center items-start h-full p-4 rounded-md">
            ...
            <button
              ...
              className="bg-[#00A297] hover:bg-[#0b0b0b] text-white font-bold px-8 py-4 rounded transition shadow text-lg w-48"
            >
              SHOP NOW
            </button>
          </div>
          ...
          >
            <div className="flex-1 flex flex-col items-end text-left">
              ...
              <button
                ...
                className="text-[#00A297] cursor-pointer font-semibold px-1 sm:px-1 py-1 sm:py-0.5 border-b-1 border-[#00A297] hover:border-transparent transition-all duration-300 text-sm sm:text-base"
              >
                SHOP NOW
              </button>
            </div>
