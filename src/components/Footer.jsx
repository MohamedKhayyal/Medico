      ...
      <div className="flex flex-wrap justify-between gap-12 md:gap-6">
        ...
        <div className="max-w-80">
          ...
          <div className="flex items-center mt-4">
            <input
              style={{ border: "1.6px solid #00A297" }}
              type="text"
              className="bg-white rounded-l h-9 px-3 outline-none"
              placeholder="Your email"
            />
            <button
              className="flex items-center justify-center  h-9 w-9 aspect-square rounded-r"
              style={{
                background: "#00A297",
              }}
            >
